...
folder_with_pdbs="/srv/scratch/z5358491/RFdiffusion/5DK3_scripts/thesis_c/insertion/50A/50A_30aa_outputs"
output_dir="/srv/scratch/z5358491/ProteinMPNN/thesis_c/insertion/50A/50A_30AA_outputs"
mkdir -p $output_dir
