...
folder_with_pdbs="/srv/scratch/z5358491/RFdiffusion/5DK3_scripts/thesis_c/insertion/30A/30A_50aa_outputs"
output_dir="/srv/scratch/z5358491/ProteinMPNN/thesis_c/insertion/30A/30A_50AA_outputs"
mkdir -p $output_dir
