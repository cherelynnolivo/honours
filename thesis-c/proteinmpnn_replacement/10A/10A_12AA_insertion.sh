...
folder_with_pdbs="/srv/scratch/z5358491/RFdiffusion/5DK3_scripts/thesis_c/replacement/10A/10A_12aa_replacement_outputs"
output_dir="/srv/scratch/z5358491/ProteinMPNN/thesis_c/replacement/10A/10A_12AA_insertion_outputs"
mkdir -p $output_dir
...
python /srv/scratch/z5358491/ProteinMPNN/helper_scripts/make_fixed_positions_dict.py \
  ...
  --chain_list "$chains_to_design" \
  --specify_non_fixed \
  --position_list "224 225 226 227 228 229 230 231 232 233 234 235, 224 225 226 227 228 229 230 231 232 233 234 235"
