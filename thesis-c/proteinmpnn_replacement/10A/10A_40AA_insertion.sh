...
folder_with_pdbs="/srv/scratch/z5358491/RFdiffusion/5DK3_scripts/thesis_c/replacement/10A/10A_40aa_replacement_outputs"
output_dir="/srv/scratch/z5358491/ProteinMPNN/thesis_c/replacement/10A/10A_40AA_insertion_outputs"
mkdir -p $output_dir
