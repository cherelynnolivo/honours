...
folder_with_pdbs="/srv/scratch/z5358491/RFdiffusion/5DK3_scripts/thesis_c/replacement/10A/10A_50aa_replacement_outputs"
output_dir="/srv/scratch/z5358491/ProteinMPNN/thesis_c/replacement/10A/10A_50AA_insertion_outputs"
mkdir -p $output_dir
...
python /srv/scratch/z5358491/ProteinMPNN/helper_scripts/make_fixed_positions_dict.py \
  ...
  --chain_list "$chains_to_design" \
  --specify_non_fixed \
  --position_list "224 225 226 227 228 229 230 231 232 233 234 235 236 237 238 239 240 241 242 243 244 245 246 247 248 249 250 251 252 253 254 255 256 257 258 259 260 261 262 263 264 265 266 267 268 269 270 271 272 273, 224 225 226 227 228 229 230 231 232 233 234 235 236 237 238 239 240 241 242 243 244 245 246 247 248 249 250 251 252 253 254 255 256 257 258 259 260 261 262 263 264 265 266 267 268 269 270 271 272 273"
