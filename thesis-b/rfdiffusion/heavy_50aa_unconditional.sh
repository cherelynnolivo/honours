...
pwd
python ../scripts/run_inference.py inference.input_pdb=$PDB_FILE inference.output_prefix=$OUTPUT_BASE/heavy_50aa_unconditional/run inference.num_designs=3 contigmap.contigs='[B1-122/50/B123-226/B233-444]'
...
echo "Output: Check $OUTPUT_BASE/heavy_50aa_unconditional*.pdb"
