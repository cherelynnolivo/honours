...
PDB_FILE="./5dk3_structures/5dk3_10A.pdb"
OUTPUT_BASE="5dk3_full_10A_20AA_outputs"
...
python ../scripts/run_inference.py inference.input_pdb=$PDB_FILE \
  ...
  inference.num_designs=9 \
  contigmap.contigs='[A1-218/0 B1-226/B233-238/20/B239-444/0 F1-218/0 G1-229/G236-238/20/G239-444/0]'
