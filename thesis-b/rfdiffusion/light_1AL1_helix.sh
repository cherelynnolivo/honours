...
echo ""
echo "What this does:"
echo "- Takes the light chain (A) from 5DK3"
...
python ../scripts/run_inference.py \
    ...
    inference.output_prefix=$OUTPUT_BASE/light_1AL1_helix/run \
    inference.num_designs=3 \
    'contigmap.contigs=[A1-114/0 '$HELIX_FILE':A1-13/0 A115-218]'

echo "Output: Check $OUTPUT_BASE/light_1AL1_helix*.pdb"
echo "You should see 3 designs with a helix from 1AL1 between VL and CL of the light chain"