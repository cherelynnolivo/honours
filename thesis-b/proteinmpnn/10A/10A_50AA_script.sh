...
folder_with_pdbs="../../../RFdiffusion/5DK3_scripts/5dk3_full_10A_50AA_outputs/"
output_dir="./10A_50AA_outputs"
mkdir -p $output_dir
...
python ../../helper_scripts/make_fixed_positions_dict.py \
  ...
  --chain_list "$chains_to_design" \
  --specify_non_fixed \
  --position_list "233 234 235 236 237 238 239 240 241 242 243 244 245 246 247 248 249 250 251 252 253 254 255 256 257 258 259 260 261 262 263 264 265 266 267 268 269 270 271 272 273 274 275 276 277 278 279 280 281 282, 233 234 235 236 237 238 239 240 241 242 243 244 245 246 247 248 249 250 251 252 253 254 255 256 257 258 259 260 261 262 263 264 265 266 267 268 269 270 271 272 273 274 275 276 277 278 279 280 281 282"
# Run ProteinMPNN
