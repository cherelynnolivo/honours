...
folder_with_pdbs="../../../RFdiffusion/5DK3_scripts/5dk3_full_40A_10AA_outputs/"
output_dir="./40A_10AA_outputs"
mkdir -p $output_dir
...
python ../../helper_scripts/make_fixed_positions_dict.py \
  ...
  --chain_list "$chains_to_design" \
  --specify_non_fixed \
  --position_list "233 234 235 236 237 238 239 240 241 242, 233 234 235 236 237 238 239 240 241 242"
